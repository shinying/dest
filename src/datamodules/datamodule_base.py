...
class BaseDataModule(LightningDataModule):
    def __init__(self, _config):
        ...
        self.nframe = _config["nframe"]
        self.max_video_len = _config["max_video_len"]
        self.trim = _config["trim"]
        self.num_clips = _config["num_clips"]
        ...
        self.ans_tokenizer = DistilBertTokenizer.from_pretrained('distilbert-base-uncased')
